...
/// <summary>
/// A collection of unit tests for the DijkstrasAlgorithm class. Note that the 
...
public class DijkstrasAlgorithmTest
{
    ...
    public void Execute_SmallMaze_ShortestPathReturned()
    {
        ...
        DijkstrasAlgorithm algorithm =
            ScriptableObject.CreateInstance<DijkstrasAlgorithm>();
